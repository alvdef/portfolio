...
* [ ] **CSS Loophole Check:** Reject any custom CSS containing `border-radius` (except `0`), `box-shadow`, `filter: drop-shadow`, `backdrop-filter`, gradient backgrounds, or spring-like easing.
